            ...
            exampleMenu.setSlots(new ArrayList<>() {
                {
                    ...
                    slot2.index = 1;
                    slot2.item = RegistryHelper.toString(Items.APPLE);
            ...
            secondMenu.setSlots(new ArrayList<>() {
                {
                    ...
                    slot1.setItem(RegistryHelper.toString(Items.GOLDEN_APPLE));
                    this.add(slot1);
                    ...
                    slot2.commands.on_left_click_commands = List.of("command-menu open %player:name% another-menu");
                    slot2.setItem(RegistryHelper.toString(Items.CLOCK));
                    this.add(slot2);
                }
            });
