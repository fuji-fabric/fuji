package io.github.sakurawald.fuji.module.initializer.command_meta.NOT;
...
public class NotInitializer extends ModuleInitializer {
    ...
    private static int $not(@CommandSource ServerCommandSource source, GreedyString command) {
