...
public class ProductionWork extends Work implements Schedulable {
    ...
    public @NotNull List<Text> ofLore(ServerPlayerEntity player) {
        ...
        ret.add(TextHelper.getTextByKey(player, "works.production_work.prop.sample_start_time", ChronosUtil.formatDate(this.sample.sampleStartTimeMS)));
        ret.add(TextHelper.getTextByKey(player, "works.production_work.prop.sample_end_time", ChronosUtil.formatDate(this.sample.sampleEndTimeMS)));
