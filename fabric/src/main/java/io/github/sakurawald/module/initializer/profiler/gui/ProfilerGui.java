package io.github.sakurawald.module.initializer.profiler.gui;
...
public class ProfilerGui extends SimpleGui {
    ...
    private List<GuiElementInterface> makeDimensionElements() {
        ...
        for (ServerWorld world : ServerHelper.getWorlds()) {
            ...
            /* Dimension name. */
            lore.add(TextHelper.getTextByKey(getPlayer(), "profiler.dimension.name", RegistryHelper.ofString(world)));
            ...
            GuiElement element = new GuiElementBuilder()
                .setItem(WorldHelper.getSensibleWorldItem(RegistryHelper.ofString(world)))
