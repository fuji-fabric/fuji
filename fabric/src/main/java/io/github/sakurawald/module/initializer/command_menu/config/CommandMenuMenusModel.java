            ...
            exampleMenu.setSlots(new ArrayList<>() {
                {
                    ...
                    slot2.index = 1;
                    slot2.item = RegistryHelper.ofString(Items.APPLE);
            ...
            secondMenu.setSlots(new ArrayList<>() {
                {
                    ...
                    slot1.setItem(RegistryHelper.ofString(Items.GOLDEN_APPLE));
                    this.add(slot1);
                    ...
                    slot2.commands.on_left_click_commands = List.of("command-menu open %player:name% another-menu");
                    slot2.setItem(RegistryHelper.ofString(Items.CLOCK));
                    this.add(slot2);
                }
            });
