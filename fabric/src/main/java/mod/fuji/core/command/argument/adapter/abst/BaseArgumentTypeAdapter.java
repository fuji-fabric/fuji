package mod.fuji.core.command.argument.adapter.abst;
...
/**
 *     An <code>ArgumentTypeAdapter</code> is used to map a specific <code>ArgumentType</code> into its <code>ArgumentValue</code>.
