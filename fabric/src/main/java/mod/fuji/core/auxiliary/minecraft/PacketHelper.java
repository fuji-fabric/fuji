...
public class PacketHelper {
    ...
    public static void sendPacket(@NotNull Packet<?> packet, @NotNull ServerPlayer player) {
    ...
    public static void sendPacketToAllExcept(@NotNull Packet<?> packet, @NotNull ServerPlayer player) {
        PlayerHelper.getPlayerManager()
            .getPlayers()
            .stream()
