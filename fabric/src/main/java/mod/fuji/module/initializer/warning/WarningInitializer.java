...
import mod.fuji.module.initializer.warning.config.model.WarningConfigModel;
import mod.fuji.module.initializer.warning.config.model.WarningDataModel;
import mod.fuji.module.initializer.warning.gui.WarningGui;
...
public class WarningInitializer extends ModuleInitializer {
    ...
    public static final BaseConfigurationHandler<WarningConfigModel> config = ObjectConfigurationHandler.ofModule(BaseConfigurationHandler.CONFIG_JSON_LITERAL, WarningConfigModel.class);
