    ...
    List<BundleCommandNode> bundleCommands = new ArrayList<>() {
        {
            ...
            this.add(new BundleCommandNode(true, "This command will roll a random dice.", new CommandRequirementDescriptor(4, null), "dice", List.of("say %player:name% just roll out %fuji:random 1 6% points.")));
