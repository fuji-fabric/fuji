...
public class RuntimeDimensionImporter {
    ...
    public static @NotNull RuntimeDimensionDescriptor importRuntimeDimensionDescriptor(IdentifierIR dimensionIdentifier, WorldPresetType worldPresetType, IdentifierIR dimensionTypeIdentifier, ChunkGeneratorType chunkGeneratorType, String chunkGeneratorParameter, long seed) {
        /* Make the descriptor. */
        ...
        if (worldPresetType != null) {
            ...
            runtimeDimensionDescriptor.dimension_type = BuiltinDimensionTypesIR.OVERWORLD.toString();
        } else {
