...
public class FujiInitializer extends ModuleInitializer {
    ...
    @Document(id = 1751826549358L, value = """
        ...
        """)
    @CommandNode("reload")
    public static int $reload(@CommandSource CommandSourceStack source) {
    ...
    public static int $userGuide(@CommandSource CommandSourceStack source) {
    ...
    @CommandNode("about")
    private static int $about(@CommandSource ServerPlayer player) {
        AboutGui
            .make(null, player)
            .open();
        return CommandHelper.Return.SUCCESS;
    ...
    private static int $inspectServerCommands(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectModules(@CommandSource ServerPlayer player) {
    ...
    @CommandNode
    private static int $inspectModulesShortcut(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectFujiCommands(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectCommandArgumentTypes(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectConfigurations(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectRegistry(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectPermissionsAndMetas(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectPlaceholders(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectJobs(@CommandSource ServerPlayer player) {
        JobsInspectionGui
            .inspectAll(null, player)
            .open();
        return CommandHelper.Return.SUCCESS;
    ...
    private static int $inspectLanguages(@CommandSource ServerPlayer player) {
    ...
    private static int $inspectMixins(@CommandSource ServerPlayer player) {
        MixinsInspectionGui
            .inspectAll(player)
            .open();
        return CommandHelper.Return.SUCCESS;
    ...
    @CommandNode("inspect events")
    private static int $inspectEvents(@CommandSource ServerPlayer player) {
        EventsInspectionGui
            .inspectAll(player)
            .open();
        return CommandHelper.Return.SUCCESS;
