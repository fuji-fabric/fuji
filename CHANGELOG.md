...
- [core] feature: unify the document style for `/fuji inspect fuji-commands` command.
- [core] feature: unify the document style for `/fuji inspect modules` command.
- [core] feature: unify the document style for `/fuji inspect configurations` command.
