...
- [world] feature: now will fall back to the `flat chunk generator` if there is no available chunk generator for the specified `dimension type`. (Makes the `/world create cave minecraft:overworld_caves` command work)
